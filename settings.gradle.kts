...
include(":feature_attendee_manager_organizer")
include(":feature_create_event_organizer")
include(":feature_booking")
include(":feature_ticket_manager_organizer")
include(":feature_sales_report_organizer")
